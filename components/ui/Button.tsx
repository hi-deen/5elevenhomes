...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = 'primary', size = 'md', isLoading, disabled, children, ...props }, ref) => {
    ...
    const variants = {
      primary: 'bg-gold hover:bg-gold-dark text-primary focus:ring-gold',
      secondary: 'bg-primary hover:bg-primary-light text-gold border border-gold focus:ring-gold',
